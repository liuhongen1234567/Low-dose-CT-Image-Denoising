...
from utls.loss_ddnet_vgg import Loss, GetMask, Vgg19
...
def main():
    ...
    save_dir ='pths'
    load_path ='{}/ddnet_vgg_save.pth'.format(save_dir)
    save_path = '{}/ddnet_vgg_save.pth'.format(save_dir)
    ...
    try:
        for epoch in range(num_epoch):
            ...
            for i, (img, gt) in enumerate(train_loader):
                ...
                predict1 = model(img)
                step1_loss, MSE_Loss1, VGG_Loss1 = Loss(predict1, gt, vgg)
                ...
                if Mask_Enable:
                    ...
                    step2_loss, MSE_Loss2, VGG_Loss2 = Loss(predict2, filter_gt, vgg)
                    total_loss = step1_loss + step2_loss
                else:
                    step2_loss, MSE_Loss2, VGG_Loss2 = 0, 0, 0
                ...
                if i % 50 == 0:
                    print(
                        "epoch {}/{} iter: {} Step 1: total loss {:.4f}, mse loss {:.4f}, perc loss {:.4f}, Step 2: total loss {:.4f}, mse loss {:.4f}, perc_loss {:.4f}; total_loss {:.4f}, memory {:.4f} ".format(
                            epoch,num_epoch,i, step1_loss, MSE_Loss1,VGG_Loss1,
                            step2_loss,MSE_Loss2,VGG_Loss2, total_loss,
